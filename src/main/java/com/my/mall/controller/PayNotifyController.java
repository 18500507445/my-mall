...
import com.my.mall.entity.param.HuaweiPayParam;
import com.my.mall.entity.param.KsPayParam;
import com.my.mall.entity.param.PayParam;
import com.my.mall.entity.pay.MyPayConfig;
import com.my.mall.entity.pay.MyPayOrder;
import com.my.mall.payment.open.*;
import com.my.mall.service.order.MyOrderService;
import com.my.mall.service.pay.impl.HuaweiServiceImpl;
import com.my.mall.service.pay.impl.KsPayServiceImpl;
import com.my.mall.service.payorder.MyPayConfigService;
import com.my.mall.service.payorder.MyPayOrderService;
            ...
            if (1 != payOrder.getTradeStatus()) {
                ...
                if (ObjectUtil.isNotNull(purchase)) {
                    ...
                    if (data.containsKey("purchaseState") && 0 == data.getInt("purchaseState") && data.containsKey("orderId") && StringUtils.equals(tradeNo, data.getStr("orderId"))) {
                        ...
                        if (payFlag > 0) {
                            myOrderService.successOrderHandler(payOrder.getSource(), payOrder.getSid(),
                                    payOrder.getBusinessCode(), orderId, payOrder.getUserName(), "1", payOrder.getFee().toString());
