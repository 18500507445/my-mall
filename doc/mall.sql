create table if not exists my_mall.my_goods
(
...
create table if not exists my_mall.my_order
(
    id              bigint(19) auto_increment
        primary key,
...
create table if not exists my_mall.my_pay_config
(
    id                bigint(19) auto_increment
        primary key,
...
create index PAY_CONFIG_INDX01
    on my_mall.my_pay_config (source);

create table if not exists my_mall.my_pay_list
(
    id               bigint(19) auto_increment
        primary key,
...
create index PAY_LIST_INDX01
    on my_mall.my_pay_list (source);

create index PAY_LIST_INDX02
    on my_mall.my_pay_list (sid);

create index UNION_KEY
    on my_mall.my_pay_list (source, sid);

create table if not exists my_mall.my_pay_order
(
    id            bigint(19) auto_increment
        primary key,
    source        varchar(64)                              null,
...
create index PAY_ORDER_INDX01
    on my_mall.my_pay_order (trade_status);

create index PAY_ORDER_INDX02
    on my_mall.my_pay_order (user_name);

create index PAY_ORDER_INDX03
    on my_mall.my_pay_order (trade_no);

create index PAY_ORDER_INDX04
    on my_mall.my_pay_order (create_time);

create table if not exists my_mall.my_seckill_order
(
    id          bigint(19) auto_increment
        primary key,
    user_id     bigint(19)                         null comment '用户id',
...
create table if not exists my_mall.my_user
(
    id          bigint(19) auto_increment
        primary key,
    name        varchar(64)                          null comment '用户名',
